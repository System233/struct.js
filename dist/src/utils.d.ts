...
export declare const IsCustomTypeInstance: (type: any) => type is TypeBase;
...
export declare const SizeOf: (type: typeof TypeBase | TypeBase | NativeType | StringType, real?: boolean) => number;
...
export declare const DumpType: <T extends typeof TypeBase>(type: T) => string;
export declare const Dump: <T extends typeof TypeBase>(type: FieldDef | T) => string;
export declare const Aligns: (addr: number, align: NativeTypeSize) => number;
export declare const GetTypeDef: <T extends typeof TypeBase>(target: T) => TypeDef;
export declare const SetTypeDef: <T extends typeof TypeBase>(target: T, option: TypeOption) => void;
...
export declare const GetTypeFields: <T extends typeof TypeBase>(type: T) => Fields;
export declare const SetTypeFields: <T extends typeof TypeBase>(type: T, fields: Fields) => boolean;
export declare const IsTypeInited: <T extends typeof TypeBase>(type: T) => boolean;
export declare const SetTypeInited: <T extends typeof TypeBase>(type: T, inited: boolean) => boolean;
export declare const GetBuffer: <T extends TypeBase>(target: T) => Uint8Array;
