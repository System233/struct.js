...
const ReadAsString = (buffer, byteOffset, byteLength, encoding) => {
...
const WriteAsString = (buffer, byteOffset, byteLength, encoding, value) => {
...
exports.WriteAsString = WriteAsString;
